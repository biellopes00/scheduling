  ...
  return (
    <section className="text-center mt-24">
      ...
      <p className="text-gray-600">
        Most Sheduling apps are simple but ours is even more simple.
        <br />
      ...
      <div className="mt-4 flex gap-5 justify-center">
        ...
        <Link href={'/'} className="border rounded-full py-2 px-4 inline-flex gap-1 items-center text-gray-800 border-gray-800">
            <Play size={24} />
            Watch video
        </Link>
      </div>
